...
import type { RoutineParameter } from "@/lib/routine-schema";
import { routineParameterTypes } from "@/lib/routine-schema";
...
interface ParameterEditorProps {
  ...
  onChange: (parameters: RoutineParameter[]) => void;
}

const emptyParam: RoutineParameter = {
  name: "",
  type: "string",
  description: "",
  required: false,
...
export function ParameterEditor({ parameters, onChange }: ParameterEditorProps) {
  function updateParam(index: number, patch: Partial<RoutineParameter>) {
  ...
  return (
    <div className="space-y-3">
      ...
      {parameters.length === 0 && (
        <p className="text-xs text-faint">No parameters. This routine takes no input.</p>
      )}
        ...
        >
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onChange={(e) =>
                updateParam(i, {
                  type: e.target.value as RoutineParameter["type"],
                  default: undefined,
                })
              }
              className="h-8 text-xs"
            >
              {routineParameterTypes.map((t) => (
