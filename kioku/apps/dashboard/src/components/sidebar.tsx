...
const links: { href: string; label: string; iconName: IconName }[] = [
  ...
  { href: "/facts", label: "Facts", iconName: "Layers" },
  { href: "/sessions", label: "Sessions", iconName: "Library" },
  { href: "/recall", label: "Recall", iconName: "Search" },
  { href: "/query", label: "Query", iconName: "MessageCircleQuestion" },
  { href: "/health", label: "Health", iconName: "Activity" },
];
