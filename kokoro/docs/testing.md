...
| `scheduler/{proactive,reminders,routines,routine-review,skill-review,review-scheduler,watchers,maintenance}.ts`                         | ❌     | —                                        | Timer-driven loops (the two review schedulers are thin wrappers over the shared `review-scheduler.ts` factory). Pipeline phase with `vi.useFakeTimers()`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
