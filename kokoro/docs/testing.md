...
| `services/skill-review.ts`                                                                                                              | ✅     | `tests/services/skill-review.test.ts`    | Weekly skill curation pass: facts-only candidate selection + ordering + cap, one-LLM-call-per-chat, refine/archive/merge routing, malformed-action fall-through, stop-after-first-proposal, `lastReviewedAt` stamping (incl. no-action verdicts; nothing on LLM failure).                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
