  ...
  return tool({
    ...
    execute: async ({ daysAhead, maxResults }) => {
      try {
        ...
        logger.error({ error: error }, "Tool: listCalendarEvents failed");
        return {
  ...
  return tool({
    ...
    execute: async ({
      ...
      try {
        ...
        logger.error({ error: error, action }, "Tool: manageCalendar failed");
        return {
          success: false,
  ...
  return tool({
    ...
    execute: async ({ action, message, fireAt, reminderId }) => {
      try {
        ...
        logger.error({ error: error, action }, "Tool: manageReminders failed");
        return {
          success: false,
